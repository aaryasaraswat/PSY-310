...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/aaryasaraswat/Documents/PSY310/SOLO PROJECT/emotion_valence_word_recall.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    recall_phase = data.Routine(
        name='recall_phase',
        components=[recall_ins, recall_box, key_resp_end],
    )
