...
expName = 'adaptive_staircase_aarya'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Admin\\OneDrive\\Documents\\Aarya\\PSY310_lab\\adaptive_staircase\\adaptive_staircase_aarya_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.StairHandler(startVal=20.0, extraInfo=expInfo,
    ...
    level = thisTrial = 20.0  # initialise some vals
